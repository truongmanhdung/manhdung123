    ...
    if name:
        ...
        while True:
            ...
            if not text:
                ...
                help_me()
            elif "ngủ chưa" in text:
                robot_brain = "em chưa ngủ ạ"
                speak(robot_brain)
            elif "người yêu" in text:
                robot_brain = "dạ em đây ạ"
                speak(robot_brain)
            elif "đi chơi với anh không" in text:
                robot_brain = "em phải ở nhà làm bài tập rồi anh, để mai nhé"
                speak(robot_brain)
            elif "ăn cơm chưa" in text:
                robot_brain = "em ăn cơm rồi ạ, anh ăn chưa"
                speak(robot_brain)
            elif "ăn rồi" in text:
                robot_brain = "vâng ạ"
                speak(robot_brain)
            elif "đang làm gì thế" in text:
                robot_brain = "em đang học bài ạ"
                speak(robot_brain)
            elif "có yêu anh không" in text:
                robot_brain = "dạ có ạ"
                speak(robot_brain)
            elif "mình đi chơi nhé" in text:
                robot_brain = "dạ vâng ạ"
                speak(robot_brain)
            elif "thích đi chơi đâu" in text:
                robot_brain = "em đi đâu cũng được ạ"
                speak(robot_brain)
            elif "anh qua đón nhé" in text:
                robot_brain = "dạ vâng ạ"
                speak(robot_brain)
            elif "có nhớ anh không" in text:
                robot_brain = "dạ có ạ"
                speak(robot_brain)
            elif "đi ngủ nhé" in text:
                robot_brain = "vâng ạ"
                speak(robot_brain)
            elif "ngủ ngon" in text:
                robot_brain = "vâng ạ, anh ngủ ngon nhé. Yêu anh"
                speak(robot_brain)
            elif "chào" in text:
                hello(name)
